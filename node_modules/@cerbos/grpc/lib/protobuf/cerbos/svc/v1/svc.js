...
exports.CerbosPlaygroundServiceClient = exports.CerbosPlaygroundServiceService = exports.CerbosAdminServiceClient = exports.CerbosAdminServiceService = exports.CerbosServiceClient = exports.CerbosServiceService = exports.protobufPackage = void 0;
/* eslint-disable */
const grpc_js_1 = require("@grpc/grpc-js");
const request_1 = require("../../../cerbos/request/v1/request");
const response_1 = require("../../../cerbos/response/v1/response");
...
exports.CerbosPlaygroundServiceService = {
    playgroundValidate: {
        path: "/cerbos.svc.v1.CerbosPlaygroundService/PlaygroundValidate",
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(request_1.PlaygroundValidateRequest.encode(value).finish()),
        requestDeserialize: (value) => request_1.PlaygroundValidateRequest.decode(value),
        responseSerialize: (value) => Buffer.from(response_1.PlaygroundValidateResponse.encode(value).finish()),
        responseDeserialize: (value) => response_1.PlaygroundValidateResponse.decode(value),
    },
    playgroundTest: {
        path: "/cerbos.svc.v1.CerbosPlaygroundService/PlaygroundTest",
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(request_1.PlaygroundTestRequest.encode(value).finish()),
        requestDeserialize: (value) => request_1.PlaygroundTestRequest.decode(value),
        responseSerialize: (value) => Buffer.from(response_1.PlaygroundTestResponse.encode(value).finish()),
        responseDeserialize: (value) => response_1.PlaygroundTestResponse.decode(value),
    },
    playgroundEvaluate: {
        path: "/cerbos.svc.v1.CerbosPlaygroundService/PlaygroundEvaluate",
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(request_1.PlaygroundEvaluateRequest.encode(value).finish()),
        requestDeserialize: (value) => request_1.PlaygroundEvaluateRequest.decode(value),
        responseSerialize: (value) => Buffer.from(response_1.PlaygroundEvaluateResponse.encode(value).finish()),
        responseDeserialize: (value) => response_1.PlaygroundEvaluateResponse.decode(value),
    },
    playgroundProxy: {
        path: "/cerbos.svc.v1.CerbosPlaygroundService/PlaygroundProxy",
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(request_1.PlaygroundProxyRequest.encode(value).finish()),
        requestDeserialize: (value) => request_1.PlaygroundProxyRequest.decode(value),
        responseSerialize: (value) => Buffer.from(response_1.PlaygroundProxyResponse.encode(value).finish()),
        responseDeserialize: (value) => response_1.PlaygroundProxyResponse.decode(value),
    },
};
exports.CerbosPlaygroundServiceClient = (0, grpc_js_1.makeGenericClientConstructor)(exports.CerbosPlaygroundServiceService, "cerbos.svc.v1.CerbosPlaygroundService");
