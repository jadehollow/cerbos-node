import type { Principal, PlanResourcesInput_Resource, Resource } from "../../../cerbos/engine/v1/engine";
...
export interface PlaygroundProxyRequest {
    ...
    proxyRequest?: {
        ...
        checkResourceSet: CheckResourceSetRequest;
    } | {
        $case: "checkResourceBatch";
        checkResourceBatch: CheckResourceBatchRequest;
    } | {
        $case: "planResources";
        planResources: PlanResourcesRequest;
    } | {
        $case: "checkResources";
        checkResources: CheckResourcesRequest;
    };
}
